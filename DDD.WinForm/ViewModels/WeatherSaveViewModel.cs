...
namespace DDD.WinForm.ViewModels
{
    public class WeatherSaveViewModel : ViewModelBase
    {
        ...
        public BindingList<Condition>Conditions { get; set; } = new BindingList<Condition>(Condition.ToLlst());
        ...
        public void Save()
        {
            ...
            var entity = new WeatherEntity(Convert.ToInt32(SelectedAreaId), DataDateValue, Convert.ToInt32(SelectedCondition), temperature);
